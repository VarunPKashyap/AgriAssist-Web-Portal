...
<div id="page-wrapper">
	<header id="header">
		...
		<nav id="nav-bar">
			<ul>
				...
				<li><a class="nav-link" href="SignOut.php">SignOut</a></li>
	...
	<section id="about">
		...
		<h4> AgriAssist is a aims to provide a fair, effective and user-friendly platform for Farmers to sell their produce to the Consumer directly, without the need of intervention from Middlemen. This system not only allows the farmer to gain a reasonable yeild
			to sustain themselves but it also enables the consumer the flexibility to choose and buy proucts of their choice, at a lower price.</h4>
	 <button id="submit" onclick="window.location.href = 'FarmerDashboard.php';">Dashboard</button>
	</section>
